...
const ProjectsSection = () => {
  ...
  const filters = [
    ...
    { id: "software", label: "Software", icon: <Server size={16} /> },
  ...
  const projects = [
    {
      ...
      image: "/images/gslearning.jpg",
      category: ["web", "api"],
      technologies: ["Django", "PostgreSQL", "AWS"],
      github: "https://github.com/EuricoTurzi/GSLearning",
      status: "completed",
      highlights: [
    ...
    {
      id: 2,
      title: "IoT Tracker Configurator",
      description:
        "Ferramenta para configuração de rastreadores IoT, permitindo monitoramento e gestão de dispositivos.",
      image: "/images/configurador.jpg",
      category: ["software"],
      technologies: ["Python", "Tkinter"],
      github: "https://github.com/EuricoTurzi/Configurador",
      status: "completed",
      highlights: [
    ...
    },
    {
      ...
      github: "https://github.com/EuricoTurzi/Euricoder-Portfolio",
      demo: "https://euricoder.dev",
      status: "completed",
    ...
    },
    {
      ...
      description:
        "API RESTful para um sistema de e-commerce, com autenticação, gestão de produtos e processamento de pedidos.",
      image: "/images/ecommerce.jpg",
      category: ["api"],
      technologies: ["Node.js", "Express", "Firestore"],
      github: "https://github.com/EuricoTurzi/e-commerce-api",
      status: "in-progress",
      highlights: [
        "RESTful Endpoints",
